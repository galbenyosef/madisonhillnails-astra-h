...
- 8 Chromium browser tests passed across desktop and emulated iPhone viewports. They check page errors, local structured data, preview noindex, responsive width, color selection, reduced motion, navigation, protected-route fallback, policies, and missing pages.
